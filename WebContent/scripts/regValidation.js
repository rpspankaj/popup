...
function init() {
   ...
   //Attach onblure handler
   document.getElementById("regForm").onblur=validateForm;
...
function validateForm() {
   return (isNotEmpty("name", "<img src=\"images/cross.png\" height=\"10\">Please enter your name!")
        ...
        && isLengthMinMax("password", "Enter a valid password!", 6, 30)
