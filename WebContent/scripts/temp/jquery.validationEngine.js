...
//Edited by me below
function checkImageFile(field, rules, i, options){
    var val = field.val();
    ...
    switch(ext){
        ...
        default:
            $(this).val('');
            return options.allrules.validate2Imagefields.alertText;
...
function checkResumeFile(field, rules, i, options){
    var val = field.val();
    var ext=val.substring(val.lastIndexOf('.') + 1).toLowerCase();
    if(ext!="shp"){
        return options.allrules.validate2Resumefields.alertText;
